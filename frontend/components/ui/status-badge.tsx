...
const toneMap: Record<string, string> = {
  ...
  disconnected: 'border border-orange-500/25 bg-orange-500/10 text-orange-200',
  closed: 'border border-slate-500/25 bg-slate-500/10 text-slate-300',
  misconfigured: 'border border-amber-500/35 bg-amber-500/10 text-amber-200',
  rate_limited: 'border border-orange-500/35 bg-orange-500/10 text-orange-200',
  ...
  info: 'border border-sky-500/25 bg-sky-500/10 text-sky-200',
